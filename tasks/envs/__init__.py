...
from .hotpot_env import HotpotEnv, HotpotRecorder
...
TASKS_PATH = {
    ...
    'hotpot': 'data/hotpot/hotpot_distractor_sample.jsonl'
}
...
with open(TASKS_PATH['hotpot'], 'r') as f:
    hotpot_tasks = [
        {
            'task': row['question'],
            'answer': row['answer'],
